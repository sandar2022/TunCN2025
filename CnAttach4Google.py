...
if all_words:
    ...
    cols = st.columns(4)
    sample_words = ["你好", "谢谢", "朋友", "学校", "妈妈", "老师", "学生", "早上","说话",
                    "拍球","河流","穿衣服","晚上","读书","唱歌","写字","汽车","飞机",
                    "海洋","公路","画图","自行车","做作业","做手工","晚上","早上","中午","树木","花园","高山",
                    "火箭","海洋","玩积木","大桥","农民","爸爸","爷爷","爷爷","妈妈","哥哥","姐妹","兄弟",
                    "工人","渔民","医生","农民","学校","上学","放学","学生","老师","朋友",
                    "读书","写字","画图","说话","唱歌","拍球","做手工","做作业","穿衣服",
                    "花园","树木","大桥","上学","医生","你","我","他","们","是","再见",
                    "我们","你们","他们","我是老师","他是学生","我们是朋友","再见，老师！",
                    "舅舅","阿姨","伯伯","叔叔","姑姑","起立","坐下","举手","叔叔","阿姨","男","女",
                    ]    
